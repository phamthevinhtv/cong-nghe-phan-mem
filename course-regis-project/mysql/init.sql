CREATE DATABASE IF NOT EXISTS course_regis;
USE course_regis;
...
CREATE TABLE IF NOT EXISTS courses (
    ...
    courseCreatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    courseUpdatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
